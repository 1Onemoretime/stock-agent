...
**Basic price queries:**
- "What's AAPL trading at?" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker AAPL`
- "Show me Tesla's price" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker TSLA`

**Technical analysis queries:**
- "Is AAPL overbought?" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker AAPL --technical`
- "Analyze TSLA with technical indicators" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker TSLA --technical`
- "Should I buy MSFT?" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker MSFT --technical`
...
- "Show me AAPL's 6-month trend" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker AAPL --period 6mo --technical`

**Multi-market queries:**
- "Analyze Tencent stock" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker 0700.HK --technical`
- "How is Moutai performing?" → Run: `python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker 600519.SS --technical`
...
Command: python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker AAPL
...
Command: python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker TSLA --technical
...
Command: python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker TSLA
...
Command: python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker 0700.HK --technical
...
Command: python3 ~/.claude/skills/stock-analyzer/scripts/main.py --ticker MSFT --period 6mo --technical
